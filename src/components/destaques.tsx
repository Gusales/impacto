...
// import Autoplay from "embla-carousel-autoplay" -- Verificar isso
                    ...
                    <CarouselItem className="min-w-full flex-shrink-0">
                        <div className="flex items-center justify-between h-screen bg-[#DAF1FF] p-5 text-black">
                                <div className="text-center mt-20 p-10">
                                    ...
                                    <p className="text-[24px] font-semibold leading-[35px] text-[#004358]">E Faça a Diferença</p>
                                </div>
                            <img className="h-screen pt-52" src={maosLevantadas} alt="" />
                        </div>
                    </CarouselItem>
                    ...
                    <CarouselItem className="min-w-full flex-shrink-0">
                        <div className="flex items-center justify-between h-screen bg-[#DAF1FF] p-5 text-black">
                                <div className="text-center mt-20 p-10">
                                    ...
                                    <p className="text-[24px] font-semibold leading-[35px] text-[#004358]">E Economize!</p>
                                </div>
                            <img className="h-screen pt-52"  alt="" />
                        </div>
                    </CarouselItem>
                        ...
                        <div className="flex items-center justify-between h-screen bg-[#DAF1FF] p-5 text-black">
                                <div className="text-center mt-20 p-10">
                                    ...
                                    <div className="flex max-w-[60%] mx-auto pt-32 items-center justify-between">
                                        ...
                                        <a href="#" className="flex"><Facebook /><p>Facebook</p></a>
